 ...
 */
#ifndef XGBOOST_TESTS_CPP_OBJECTIVE_TEST_LAMBDARANK_OBJ_H_
#define XGBOOST_TESTS_CPP_OBJECTIVE_TEST_LAMBDARANK_OBJ_H_
...
#endif  // XGBOOST_TESTS_CPP_OBJECTIVE_TEST_LAMBDARANK_OBJ_H_
